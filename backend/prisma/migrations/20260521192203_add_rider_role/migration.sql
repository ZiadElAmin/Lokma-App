...
INSERT INTO "new_Order" ("aiVerified", "createdAt", "deliveredAt", "id", "isAccepted", "isDelivered", "isPaid", "isRejected", "paidAt", "paymentMethod", "paymentResult", "shippingAddress", "shippingPrice", "taxPrice", "totalPrice", "updatedAt", "userId") SELECT "aiVerified", "createdAt", "deliveredAt", "id", "isAccepted", "isDelivered", "isPaid", "isRejected", "paidAt", "paymentMethod", "paymentResult", "shippingAddress", "shippingPrice", "taxPrice", "totalPrice", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
